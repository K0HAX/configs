...
** Set up notes and todos
   ...
   #+BEGIN_SRC emacs-lisp
   (setq org-default-notes-file "~/ownCloud/org-mode/work.org")

   ;; Org-Mode Capture Templates
   (defvar org-capture-templates)
   (setq org-capture-templates
         '(("t" "Todo" entry (file+headline "~/ownCloud/org-mode/refile.org" "Tasks")
            "* TODO %?\n%U\n%a\n" :clock-in t :clock-resume t)
           ("r" "Respond" entry (file "~/ownCloud/org-mode/refile.org")
            "* NEXT Respond to %:from %:subject\nSCHEDULED: %t\n%U\n%a\n" :clock-in t :clock-resume t :immediate-finish t)
           ("j" "Journal" entry (file+datetree "~/ownCloud/org-mode/journal.org")
            "* %? %?\n%U\n" :clock-in t :clock-resume t)
           ("m" "Meeting" entry (file "~/ownCloud/org-mode/refile.org")
            "* MEETING with %? :MEETING:\n%U" :clock-in t :clock-resume t)
           ("p" "Phone call" entry (file "~/ownCloud/org-mode/refile.org")
            "* PHONE %? :PHONE:\n%U" :clock-in t :clock-resume t)))
